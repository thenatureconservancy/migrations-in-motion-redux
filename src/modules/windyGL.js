...
export function Windy(params, config) {
  ...
  // var TRANSPARENT_BLACK = config.TRANSPARENT_BLACK; // [255, 0, 0, 0];
  ...
  var animate = function(bounds, field) {
    function windIntensityColorScale(step, maxWind) {
      ...
      //result = ["#fc47dc", "#f46d43", "#fdae61", "#fee090", "#ffffbf", "#e0f3f8", "#abd9e9", "#74add1", "#4575b4"];
    ...
    function draw() {
      ...
      //console.log(COMPOSITE_OPERATION);
